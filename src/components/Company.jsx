...
const Company = () => {
  return (
    <div className="bg-gray-100 py-24">
      ...
      <div className="images flex flex-wrap mr-[13%] ml-[13%] justify-between mb-20">
        <img
          className="w-40 h-40"
        ...
        <img
          className="w-40 h-40"
          src="https://yevgenysim-turkey.github.io/shopper/assets/img/products/product-19.jpg"
          alt=""
        />
        <img
          className="w-40 h-40"
          src="https://yevgenysim-turkey.github.io/shopper/assets/img/products/product-20.jpg"
          alt=""
        />
        <img
          className="w-40 h-40"
          src="	https://yevgenysim-turkey.github.io/shopper/assets/img/products/product-21.jpg"
          alt=""
        />
      </div>
